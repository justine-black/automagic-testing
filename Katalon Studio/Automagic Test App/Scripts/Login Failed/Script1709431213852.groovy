...
WebUI.setText(findTestObject('Object Repository/Page_Automagic Test App/Signin Test Objects/input_Email Address_email'), 'invalid@email.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Automagic Test App/Signin Test Objects/input_Password_password'), 'NaRTu7UBtmqbh3rjtTIiEhbj7m+LuCLa')
...
WebUI.verifyElementText(findTestObject('Page_Automagic Test App/Signin Test Objects/Login Alert Dialog'), 'Login failed')
